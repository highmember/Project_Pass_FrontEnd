...
@Component({
    selector: 'app-p3-dialog',
    templateUrl: './p3-dialog.component.html',
    styleUrls: ['./p3-dialog.component.css']
  })
  export class P3DialogComponent implements OnInit {
    public assign: any[];
    /**
    ...
    */
    ...
    constructor(
      ...
      private dialogRef: MatDialogRef<P3DialogComponent>,
