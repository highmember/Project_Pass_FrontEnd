...
@Component({
  selector: 'app-assign-past4',
  templateUrl: './assign-past4.component.html',
  styleUrls: ['./assign-past4.component.css']
})
export class AssignPast4Component implements OnInit {
  name: any;
  /**
  ...
  */
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AssignPast4Component>,
