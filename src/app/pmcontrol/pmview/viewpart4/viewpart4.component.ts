...
@Component({
  ...
  styleUrls: ['./viewpart4.component.css']
})
export class Viewpart4Component implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<Viewpart4Component>,
  ...
  checkAssign() {
    this.assign.forEach(element => {
      if (element.assignEmpType === 'Part4' && element.assignProject === this.data.project_id) {
