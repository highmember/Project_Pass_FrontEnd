...
@Component({
  selector: 'app-flie-p2-dialog',
  templateUrl: './p2-flie-dialog.component.html',
})
export class P2FileDialogComponent implements OnInit {
  public file: any[];
  ...
  */
  constructor(
    ...
    private dialogRef: MatDialogRef<P2FileDialogComponent>,
